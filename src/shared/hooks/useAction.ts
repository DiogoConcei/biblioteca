...
export default function useAction() {
  ...
  async function ratingSerie(e: React.MouseEvent, serie: Literatures, rating: number) {
    e.stopPropagation();
  ...
  async function markAsRead(e: React.MouseEvent, selectedChapter: LiteratureChapter) {
    e.stopPropagation();
  ...
  async function openChapter(e: React.MouseEvent, selectedChapter: LiteratureChapter) {
    e.stopPropagation();
    ...
    const result = await window.electronAPI.series.recentSerie(dataPath, serieName);

...
interface PdfViewerProps {
  ...
  onPdfLoaded: (
    ...
    totalPages: number,
    outline: { href?: string; label?: string; title?: string; dest?: unknown }[],
  ) => void;
  onPageChange: (page: number) => void;
}

const PdfViewer = forwardRef<PdfViewerRef, PdfViewerProps>(
  ({ path, currentPage, scale, readingMode, onPdfLoaded, onPageChange }, ref) => {
    const [pdfDocument, setPdfDocument] = useState<pdfjsLib.PDFDocumentProxy | null>(
      null,
    );

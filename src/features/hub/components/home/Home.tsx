...
import { LiteratureForm } from '../../types/literature.interface';
...
export default function Home() {
  ...
  const filteredSeries = useMemo(() => {
    return series?.filter((serie) => {
      ...
      const bySearch =
        termoMinusculo === '' || normalizedSerieName.includes(normalizedSearchTerm);

      const byLiteratureForm =
        !selectedLiteratureForm || serie.literatureForm === selectedLiteratureForm;
              ...
              >
                ...
                <div className={styles['cover-actions']}>
                  <button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      navigate(`/edit/serie/${serie.name}/${serie.literatureForm}`);
                    }}
                  >
                    <Pencil size={'24'} />
                  </button>

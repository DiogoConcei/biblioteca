  ...
  return (
    <section className={styles.card}>
      <article>
        ...
        <p>
          Permite acessar a biblioteca a partir do navegador de um dispositivo móvel na
          mesma rede Wi-Fi.
        </p>
        ...
        {errorLog && <p className={styles.errorText}>{errorLog}</p>}
        ...
        {lanStatus.active && (
          <div className={styles.inlineSettings}>
            <div className={styles.lanContainer}>
              <div className={styles.lanInfo}>
                ...
                <p className={styles.warningInfo}>
                  <em>
                    Aponte a câmera do celular para o QR Code ao lado para conectar
                    instantaneamente.
                  </em>
                </p>
              </div>
            ...
            <p className={styles.warningInfo}>
              <em>
                Mantenha o Desktop ligado e com o aplicativo aberto para continuar lendo
                no seu celular.
              </em>
            </p>
          </div>

...
export default function BackupSettings() {
  ...
  const [interval, setInterval] = useState<'diário' | 'semanal' | 'mensal'>('diário');
  ...
  return (
    <article className={styles.card}>
      ...
      <form onSubmit={handleCreateBackup} className={styles.form}>
        ...
        >
          {busyAction === 'create-backup' ? 'Criando backup...' : 'Criar Backup Agora'}
        </button>
      </form>
      ...
      <div className={styles.inlineSettings}>
        <div className={styles.backupDiv}>
          <input
            ...
            onChange={(e) => void persistSettings({ backupAuto: e.target.checked })}
